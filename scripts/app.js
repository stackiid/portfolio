...
// =========================================================
//          LIQUID HEADER SCROLL-PROGRESS FILL
// Drives the .header-progress-fill width as a percentage of total
// page scroll progress (0% at the top, 100% at the bottom).
// Updates are rAF-throttled and only ever touch `style.width` on a
// small, absolutely-positioned element, so this stays smooth and
// avoids any layout thrashing while scrolling.
// =========================================================
function initHeaderScrollProgress() {
  const fills = document.querySelectorAll(".header-progress-fill");
