...
//                        PROJECTS
// ---------------------------------------------------------
// Add a new project by copying an entry below and giving it
// the next id. Set visitEnabled to false to hide the "Visit"
// link (used while a demo is temporarily offline).
//   id, title, description, image, demo, tags, visitEnabled
// =========================================================
...
const projects = [
  ...
  // Copy this template, fill in the fields, and increment the id.
  // {
  //   id: 7,
  //   title: "",
  //   description: "",
